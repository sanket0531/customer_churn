...
x_train_scailed=scaler.fit_transform(x_train_transformed)
x_test_scailed=scaler.transform(x_test_transformed)
...
result = model.fit(x_train_scailed,y_train,batch_size=50,epochs=100,verbose=1,validation_split=0.2)

model.save("churn_model.h5")

import joblib

joblib.dump(transformar, "transformer.pkl")
